...
const String weatherCameraImagesUrl = 'https://hydrology.gov.np/gss/api/socket/airport_display/response';
const String weatherCameraImagesDetailsUrl = 'https://daq.hydrology.gov.np/idaq-files/';
